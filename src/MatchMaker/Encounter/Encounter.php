...
use App\Domain\MatchMaker\Exceptions;
use App\Domain\MatchMaker\Exceptions\ExceptionSetStatus;
...
class Encounter
{
    ...
    {
        try(!\in_array($status, [self::STATUS_PLAYING, self::STATUS_OVER], true)) {
            throw new ExceptionSetStatus();
